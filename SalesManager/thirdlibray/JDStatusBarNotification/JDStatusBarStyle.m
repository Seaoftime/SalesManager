...
NSString *const JDStatusBarStyleYWheaderStyel  = @"JDStatusBarStyleYWheaderStyel";
...
+ (NSArray*)allDefaultStyleIdentifier;
{
    return @[JDStatusBarStyleError, JDStatusBarStyleWarning,
             ...
             JDStatusBarStyleDark,JDStatusBarStyleYWheaderStyel];
}
...
+ (JDStatusBarStyle*)defaultStyleWithName:(NSString*)styleName;
{
    ...
    // JDStatusBarStyleMatrix
        ...
        style.progressBarHeight = 2.0;
        return style;
    }else if([styleName isEqualToString:JDStatusBarStyleYWheaderStyel]){
        style.barColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:.8f];
        style.textColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:.8f];
        style.font = [UIFont fontWithName:@"Courier-Bold" size:14.0];
        style.progressBarColor = [UIColor blackColor];
        style.progressBarHeight = 2.0;
        return style;
    }
