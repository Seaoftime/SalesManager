...
{
    [super prepare];
    //[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(observerForNetwork) name:@"headerForNetwork" object:nil];
    // 初始化文字
    if (isNetWork) {
        ...
        [self setTitle:MJRefreshBackFooterIdleText forState:MJRefreshStatePulling];
        [self setTitle:MJRefreshBackFooterIdleText forState:MJRefreshStateRefreshing];
    }
...
//    [self setTitle:MJRefreshHeaderPullingText forState:MJRefreshStatePulling];
//    [self setTitle:MJRefreshHeaderRefreshingText forState:MJRefreshStateRefreshing];
//    //[self setTitle:MJRefreshHeaderRefreshNoNetwork forState:MJRefreshStateNoNetwork];
}


//- (void)observerForNetwork
//{
//    // 初始化文字
//    if (isNetWork) {
//        
