...
NSString *const MJRefreshAutoFooterNoMoreDataText = @"全部加载完成";

NSString *const MJRefreshBackFooterIdleText = @"无网络连接";
NSString *const MJRefreshBackFooterPullingText = @"松开立即加载更多";
NSString *const MJRefreshBackFooterRefreshingText = @"正在加载更多...";
NSString *const MJRefreshBackFooterNoMoreDataText = @"全部加载完成";

NSString *const MJRefreshHeaderRefreshNoNetwork = @"无网络连接";
