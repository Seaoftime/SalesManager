...
- (id)init
{
    if ((self = [super init]))
    {
        ...
        memCache.name = @"com.hackemist.SDWebImageCache.default";

        // Init the disk cache
        NSArray *paths = NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES);
        diskCachePath = SDWIReturnRetained([[paths objectAtIndex:0] stringByAppendingPathComponent:@"com.hackemist.SDWebImageCache.default"]);
